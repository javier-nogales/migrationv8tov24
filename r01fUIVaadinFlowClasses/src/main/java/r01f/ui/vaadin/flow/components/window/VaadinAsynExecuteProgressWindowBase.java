...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public VaadinAsynExecuteProgressWindowBase(final String winCaption,
		...
		////////// Window properties	
		if (winCaption != null) this.setHeaderTitle(winCaption);
...
/////////////////////////////////////////////////////////////////////////////////////////	
	private void _setBehavior() {
		this.addDialogCloseActionListener(event -> _cleanExit());
	}
/////////////////////////////////////////////////////////////////////////////////////////
//	PUBLIC METHODS
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void runTask(final Callable<T> lengthyOperation) {
		...
		try {
			...
			vaadinUI.setPollInterval(2000);		// server push: pooling every 2sg
									...
									public void onFailure(final Throwable th) {
										...
										vaadinUI.access(() -> {
															if (!CancellationException.class.isAssignableFrom(th.getClass())) {
																Notification.show("ERROR: " + th.getMessage());
															} else {
																_onCancelled();
															}
															vaadinUI.setPollInterval(-1);	// cancel polling
	...
	protected void _cleanExit() {
		...
		// cancel polling
		UI ui = UI.getCurrent();
		if (ui != null) ui.setPollInterval(-1);	// cancel polling
