...
import r01ui.base.components.menu.VaadinUserMenu.R01UILangButton;
import r01ui.base.components.menu.VaadinUserMenu.R01UILanguageChangeEventListener;
import r01ui.base.components.menu.VaadinUserMenu.VaadinLangButtons;
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	protected VaadinLangButtons _langChangeButtons = null;
/////////////////////////////////////////////////////////////////////////////////////////
// 	CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public VaadinUIHeaderBase(final UII18NService i18n,
					   	  	  ...
					   	  	  final SecurityContext securityContext,
					   	  	  final Component rightComponent,
					   	  	  final boolean showLangChangeButtons,
					   	  	  final Language... supportedLangs) {
		...
		if (showLangChangeButtons) {
			lyRight.addComponent(_createLangChangeButtons(i18n.getCurrentLocale(),
														  supportedLangs));
		}
...
//
/////////////////////////////////////////////////////////////////////////////////////////
	private Component _createLangChangeButtons(final Locale loc,
											   final Language... supportedLangs) {
		Collection<R01UILangButton> langButtons = _userMenu.createLanguageChangeButtons(supportedLangs);
		_langChangeButtons = _userMenu.new VaadinLangButtons(langButtons);
		if (_langChangeButtons.hasData()) {
			HorizontalLayout hlyLang =  new HorizontalLayout();
			hlyLang.setDefaultComponentAlignment(Alignment.MIDDLE_RIGHT);
			hlyLang.setSpacing(false);
			hlyLang.setMargin(false);
			int i = 0;
			for (R01UILangButton langButton : _langChangeButtons) {
				langButton.getButton().setCaption(langButton.getButton().getCaption().toUpperCase());
				hlyLang.addComponent(langButton.getButton());
	  			if (i < langButtons.size()-1)
	  				hlyLang.addComponent(new Label("|"));
	  			i++;
			}
			_langChangeButtons.setCurrent(Languages.of(loc));
			_langChangeButtons.setStyle(ValoTheme.BUTTON_LINK);
			return hlyLang;
		}
		return null;
	}
...
/////////////////////////////////////////////////////////////////////////////////////////
	public void setUserInfoButtonCaption(final String buttonCaption) {
		_userMenu.setUserInfoButtonCaption(buttonCaption);
	}
}
