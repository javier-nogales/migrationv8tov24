...
/////////////////////////////////////////////////////////////////////////////////////////
	private Window _createNotificationsWindow(final UII18NService i18n) {
		...
		outWin.setClosable(true);
		outWin.setResizable(false);
		outWin.setDraggable(false);
		outWin.setCaption(i18n.getMessage("notifications"));

		Component notificationComp = _createNotificationsWindowContent(i18n);
		outWin.setContent(notificationComp);
