...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public VaadinCollectionManageRowComponent addItem(final V viewObj) {
		...
		editRow.setViewDataChanged(true);
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void setViewDataChanged(final boolean changed) {
		_changed = changed;
		_rowStream().forEach(component -> component.setViewDataChanged(changed));
	}
	@Override
	public boolean hasViewDataChanged() {
		return _changed || _rowStream().anyMatch(component -> component.hasViewDataChanged());
	}
/////////////////////////////////////////////////////////////////////////////////////////
//	STYLING METHODS
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private class VaadinCollectionManageRowComponent
	   ...
	   implements VaadinFormEditsViewObject<V>,
		...
		private void _setBehavior() {
			...
			// Remove
			_btnRemove.addClickListener(clickEvent -> this.enterDelete());
			...
			VaadinProceedGateDialogWindow proceedGatewayPopUp = new VaadinProceedGateDialogWindow(_i18n,
																								  ...
																								  () -> {
																										...
																										V removedViewObj = _viewObjFactory.create();
																							   			...
																							   			VaadinCollectionManageComponent.this.setViewDataChanged(true);
