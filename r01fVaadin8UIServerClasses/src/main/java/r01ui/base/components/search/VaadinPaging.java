...
//	EVENT LISTENER
/////////////////////////////////////////////////////////////////////////////////////////	
	private VaadinPagingEventListener _pagingListener;
...
// 	EVENT LISTENER  
/////////////////////////////////////////////////////////////////////////////////////////
	public void setPagingListener(final VaadinPagingEventListener listener) {
		_pagingListener = listener;
	}
	public interface VaadinPagingEventListener 
	     	 extends Serializable {	
		void onPageRequested(int firstItemNum,int numItems);
	}
	@Deprecated
	public interface R01UIPagingEventListener 
	     	 extends VaadinPagingEventListener {
		// just extends
	}	
}