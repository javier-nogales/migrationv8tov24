...
@Accessors(prefix="_")
public class TinyMCETextFieldComponentV2
...
//	CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////	
	public TinyMCETextFieldComponentV2(final UII18NService i18n) {
		this(i18n, null);
	}
	public TinyMCETextFieldComponentV2(final UII18NService i18n,
...
/////////////////////////////////////////////////////////////////////////////////////////
	public class TinyMCETextFieldWindow
		...
		////////// FIELDS
		private final TinyMCETextField _tinyEditor = new TinyMCETextField();
		...
		public TinyMCETextFieldWindow(final String caption,
			...
			// init tiny with current language
			_tinyEditor.setConfig(Strings.customized("{language: '{}'}",
		...
		private void _acceptClickListenerEvent() {
			...
			if (!oldValue.equals(_hiddenField.getValue())) {
				TinyMCETextFieldComponentV2.this.fireEvent(new ValueChangeEvent<>(TinyMCETextFieldComponentV2.this,
																						  oldValue,
																						  true));
			}
		}
