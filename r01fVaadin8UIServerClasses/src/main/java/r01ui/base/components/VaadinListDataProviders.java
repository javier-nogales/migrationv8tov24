...
/////////////////////////////////////////////////////////////////////////////////////////
	private interface VaadinDataProviderAccessor<T,SELF_TYPE extends VaadinDataProviderAccessor<T,SELF_TYPE>> {
		...
		public Stream<T> getUnderlyingItemStream();
		...
		public Stream<T> getItemsMatchingStream(final Predicate<T> pred);
		...
		public int getItemIndexOfItemMatching(final Predicate<T> pred);
	...
	private abstract class VaadinDataProviderAccessorBase<T,
		...
		@Override
		public Stream<T> getUnderlyingItemStream() {
			return this.getUnderlyingItemsCollectionAsList()
					   .stream();
		}
		@Override
		public int getUnderlyingItemsCollectionSize() {
		...
		@Override
		public Collection<T> getItemsMatching(final Predicate<T> pred) {
			return this.getItemsMatchingStream(pred)
					   .collect(Collectors.toList());
		}
		@Override
		public Stream<T> getItemsMatchingStream(final Predicate<T> pred) {
			return this.getUnderlyingItemStream()
					   .filter(pred);
		}
		@Override @SuppressWarnings("unchecked")
		public SELF_TYPE refreshItem(final T item) {
		...
		@Override
		public int getItemIndexOfItemMatching(final Predicate<T> pred) {
			T itemMatching = this.getUnderlyingItemStream()
								 .filter(pred)
								 .findFirst().orElse(null);
			return this.getItemIndex(itemMatching);
		}
		@Override @SuppressWarnings("unchecked")
		public SELF_TYPE moveItem(final T item,final int newIndex) {
