...
//	STATUS 
/////////////////////////////////////////////////////////////////////////////////////////
	// Allow upper bound hour lower than lower bound hour (next day)
	protected boolean _validateUpperBoundBiggerThanLowerBound = true;
/////////////////////////////////////////////////////////////////////////////////////////
//	CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public Range<T> getValue() {
		...
		// If there is no need to validate upper hour bigger than lower hour set lower day before upper day
		if (!_validateUpperBoundBiggerThanLowerBound
				&& up != null && low != null
				&& (low.compareTo(up) > 0)) {
			int daysBetweenDates =  low.get(ChronoField.DAY_OF_YEAR) - up.get(ChronoField.DAY_OF_YEAR) +1;
			low = (T) low.minus(daysBetweenDates,ChronoUnit.DAYS);
		}
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Registration addValueChangeListener(final ValueChangeListener<Range<T>> listener) {
		...
		_dateLowerBound.addValueChangeListener(valChangeEvent -> {
													...
													// If there is no need to validate upper hour bigger than lower hour set lower day before upper day
													if (!_validateUpperBoundBiggerThanLowerBound
															&& currUp != null && currLow != null
															&& (currLow.compareTo(currUp) > 0)) {
														int daysBetweenDates =  currLow.get(ChronoField.DAY_OF_YEAR) - currUp.get(ChronoField.DAY_OF_YEAR) +1;
														currLow = (T) currLow.minus(daysBetweenDates,ChronoUnit.DAYS);
													}
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public void setValidateUpperBoundBiggerThanLowerBound(final boolean validate) {
		_validateUpperBoundBiggerThanLowerBound = validate;
	}	
/////////////////////////////////////////////////////////////////////////////////////////
//	PRIVATE METHODS
/////////////////////////////////////////////////////////////////////////////////////////	
	private boolean _isNotValidRange(final T currLow,
		...
		if (!_validateUpperBoundBiggerThanLowerBound) {
			return false;
		} else if (_isDateTimeRangeComponent()) {
