package r01f.ui.vaadin.flow.clipboard;
...
/////////////////////////////////////////////////////////////////////////////////////////	
	public static void setTextInJSSessionStorage(final String textToBeCopiedToTheClipboard) {
		UI.getCurrent()
		  .getPage()
		  .executeJs(_composeSetTextInJSSessionStorageStript(textToBeCopiedToTheClipboard));
	}
	public static void addCopyToClipboardScriptWhenClikckAnElementWithId(final String btnId) {
		UI.getCurrent()
		  .getPage()
		  .executeJs(_composeCopyToClipboardScript(btnId));
	}
	/**
	 * Using:
	 * <pre class='brush:java'>
